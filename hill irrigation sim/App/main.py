...
def Float():
    ...
    if cnt<50:
        cnt+=1
        sleep(0.01)
        bt_strt.place(x=scr_width/2-495/2, y=scr_height/2-150-cnt)
        Float()
...
def Start():
    ...
    if flw_cnt <5:
        ques = ['images/q1.png','images/q2.png','images/q3.png','images/q4.png','images/q5.png']
        bt_strt.destroy()
        ...
        btn_yes.place(x=400,y=400)
        btn_no.configure(command=no)
        btn_no.place(x=900,y=400)
    ...
    if flw_cnt==5:
        ...
        photo = PhotoImage(file = "images/AIClick.png")
...
photo = PhotoImage(file = "images/WELCOME.png")
photoimage = photo.subsample(1,1)

obj_yes = PhotoImage(file = "images/yes.png")
img_yes = obj_yes.subsample(2, 2)

obj_no = PhotoImage(file = "images/no.png")
...
pic = PhotoImage(file="images/output_pnl.png")
